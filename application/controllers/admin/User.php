...
class User extends CI_Controller {
    ...
    {   
        if ($_POST) {
            ...
            if (empty($email)) {
                $user_id = $this->common_model->insert($data, 'soc_user');
    ...
    public function update($id)
    {
        ...
        $data['soc_user'] = $this->common_model->get_single_user_info($id);
    ...
    public function active($id) 
    {
        ...
        $data = $this->security->xss_clean($data);
        $this->common_model->update($data, $id,'soc_user');
