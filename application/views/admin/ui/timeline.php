                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <ul class="timeline">
                                <li>
                                    <div class="timeline-badge success"><img class="img-responsive" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/users/genu.jpg"> </div>
                                ...
                                <li class="timeline-inverted">
                                    <div class="timeline-badge warning"><img class="img-responsive" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/users/ritesh.jpg"> </div>
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">Ritesh Deshmukh</h4>
                                        </div>
                                        <div class="timeline-body">
                                            <p><img class="img-responsive" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/big/img1.jpg"></p>
