                                ...
                                <div class="col-md-8 p-20">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="<?php echo base_url(); ?>optimum/plugins/images/users/varun.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="<?php echo base_url(); ?>optimum/plugins/images/users/genu.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a>
                                        </div>
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="<?php echo base_url(); ?>optimum/plugins/images/users/ritesh.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a>
                                                </div>
                                                <div class="media-body">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-right">
                                            <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="<?php echo base_url(); ?>optimum/plugins/images/users/salman.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left">
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">Media heading</h4> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. </div>
                                        <div class="media-right">
                                            <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="<?php echo base_url(); ?>optimum/plugins/images/users/govinda.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 p-20">
