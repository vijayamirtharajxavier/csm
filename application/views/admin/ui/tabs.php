                            ...
                            <div class="vtabs">
                                <ul class="nav tabs-vertical">
                                    <li class="tab nav-item active">
                                        <a data-toggle="tab" class="nav-link" href="#home3" aria-expanded="true"> <span class="visible-xs"><i class="ti-home"></i></span> <span class="hidden-xs">Home</span> </a>
                                    </li>
                                    <li class="tab nav-item">
                                        <a data-toggle="tab" class="nav-link" href="#profile3" aria-expanded="false"> <span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Profile</span> </a>
                                    </li>
                                    <li class="tab nav-item">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="vtabs customvtab">
                                <ul class="nav tabs-vertical">
                                    <li class="tab nav-item active">
                                        <a data-toggle="tab" class="nav-link" href="#vhome3" aria-expanded="true"> <span class="visible-xs"><i class="ti-home"></i></span> <span class="hidden-xs">Home</span> </a>
                                    </li>
                                    <li class="tab nav-item">
                                        <a data-toggle="tab" class="nav-link" href="#vprofile3" aria-expanded="false"> <span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Profile</span> </a>
                                    </li>
                                    <li class="tab nav-item">
                                        <a aria-expanded="false" class="nav-link" data-toggle="tab" href="#vmessages3"> <span class="visible-xs"><i class="ti-email"></i></span> <span class="hidden-xs">Messages</span> </a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                        ...
                        <div class="white-box">
                            ...
                            <div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
                                <ul role="tablist" class="nav nav-tabs" id="myTabs">
                                    <li class="active nav-item" role="presentation"><a aria-expanded="true" class="nav-link" aria-controls="home" data-toggle="tab" role="tab" id="home-tab" href="#home5">Home</a></li>
                                    <li role="presentation" class="nav-item"><a aria-controls="profile" class="nav-link" data-toggle="tab" id="profile-tab" role="tab" href="#profile5" aria-expanded="false">Profile</a></li>
                                    <li class="dropdown nav-item" role="presentation">
                                        <a aria-controls="myTabDrop1-contents" class="nav-link dropdown-toggle" data-toggle="dropdown" class="dropdown-toggle" id="myTabDrop1" href="#" aria-expanded="false">Dropdown</a>
                                        <div class="dropdown-menu" id="myTabDrop1-contents" aria-labelledby="myTabDrop1">
                                            <a aria-controls="dropdown1" data-toggle="tab" class="dropdown-item" id="dropdown1-tab" role="tab" href="#dropdown1" aria-expanded="true">@fat</a>
                                            <a aria-controls="dropdown2" data-toggle="tab" class="dropdown-item" id="dropdown2-tab" role="tab" href="#dropdown2" aria-expanded="false">@mdo</a>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="col-md-6 col-lg-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <ul class="nav customtab2 nav-tabs" role="tablist">
                                <li role="presentation" class="nav-item"><a href="#home6" class="nav-link active" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs"> Home</span></a></li>
                                <li role="presentation" class="nav-item"><a href="#profile6" class="nav-link" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Profile</span></a></li>
                                <li role="presentation" class="nav-item"><a href="#messages6" class="nav-link" aria-controls="messages" role="tab" data-toggle="tab" aria-expanded="true"><span class="visible-xs"><i class="ti-email"></i></span> <span class="hidden-xs">Messages</span></a></li>
                                <li role="presentation" class="nav-item"><a href="#settings6" class="nav-link" aria-controls="settings" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-settings"></i></span> <span class="hidden-xs">Settings</span></a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills m-b-30 ">
                                    <li class="active nav-item"> <a href="#navpills-1" class="nav-link" data-toggle="tab" aria-expanded="false">Tab One</a> </li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills pull-right">
                                    <li class=" nav-item"> <a href="#navpills-11" class="nav-link active" data-toggle="tab" aria-expanded="true">Tab One</a> </li>
                                    <li class="nav-item"> <a href="#navpills-21" class="nav-link" data-toggle="tab" aria-expanded="false">Tab Two</a> </li>
                                    <li class="nav-item"> <a href="#navpills-31" class="nav-link" data-toggle="tab" aria-expanded="false">Tab Three</a> </li>
                                </ul>
                                <div class="clearfix"></div>
                                <div class="tab-content  br-n pn">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs " role="tablist">
                                <li role="presentation" class="active nav-item"><a href="#ihome" class="nav-link" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="true"><span><i class="ti-home"></i></span></a></li>
                                <li role="presentation" class="nav-item"><a href="#iprofile" class="nav-link" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false"><span><i class="ti-user"></i></span> </a></li>
                                <li role="presentation" class="nav-item"><a href="#imessages" class="nav-link" aria-controls="messages" role="tab" data-toggle="tab" aria-expanded="false"><span><i class="ti-email"></i></span></a></li>
                                <li role="presentation" class="nav-item"><a href="#isettings" class="nav-link" aria-controls="settings" role="tab" data-toggle="tab" aria-expanded="false"><span><i class="ti-settings"></i></span></a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="vtabs">
                                <ul class="nav tabs-vertical">
                                    <li class="tab nav-item active">
                                        <a data-toggle="tab" class="nav-link" href="#vihome3" aria-expanded="true"> <span><i class="ti-home"></i></span></a>
                                    </li>
                                    <li class="tab nav-item">
                                        <a data-toggle="tab" class="nav-link" href="#viprofile3" aria-expanded="false"> <span><i class="ti-user"></i></span></a>
                                    </li>
                                    <li class="tab nav-item">
                                        <a aria-expanded="false" class="nav-link" data-toggle="tab" href="#vimessages3"> <span><i class="ti-email"></i></span></a>
                                    </li>
                                </ul>
                                <div class="tab-content">
