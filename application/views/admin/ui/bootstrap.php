                    ...
                    <div class="col-lg-12">
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h3 class="box-title">Colleps Example</h3>
                                    <a class="btn btn-info m-r-15" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Link with href</a>
