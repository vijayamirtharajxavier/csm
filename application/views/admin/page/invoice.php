                        ...
                        <div class="white-box printableArea">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <address>
                                            <h3> &nbsp;<b class="text-danger">Codeigniter Admin Template</b></h3>
                                    ...
                                    <div class="pull-right text-right">
                                        <address>
                                            <h3>To,</h3>
                                            <h4 class="font-bold">John Doe & Sons,</h4>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="text-right">
                                        <button class="btn btn-info" type="submit"> Proceed to payment </button>
