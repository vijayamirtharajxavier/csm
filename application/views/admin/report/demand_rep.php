           ...
           <div class="panel panel-info">
                ...
                <?php endif ?>
                    ...
                    <div class="pull-right"> 
                        ...
                        <select style="max-width: 300px;" id="divisionlist"  class="custom-select col-6 form-control"></select><span>
                        <label>Select a Month</label> 
                        
                        <input id="month_year" name="month_year">
...
$('#search_oldbtn').on('click',function(){
...
//$("#manageDemandTable").dataTable().fnDestroy();
 ...
 manageDemandTable =  $('#manageDemandTable').DataTable( 
  {
    "ajax"    : url+'?month_year=' + mm_yy + '&div_id=' + divid, //+ 'fetchReceiptSearch',
...
title: function() {
 ...
 title: system_name + '\n' + 'Demand Report for the month of ' +$('#month_year').val(),
