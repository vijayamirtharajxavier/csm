...
<head>
    ...
    <!--   <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>optimum/css/bootstrap.min.css">
    ...
    <link href="<?php echo base_url();?>optimum/css/bootstrap4-toggle.min.css" rel="stylesheet">
    ...
    <link href="<?php echo base_url();?>optimum/css/colors/blue.css" id="theme" rel="stylesheet">
    <?php } ?>

    <link rel="stylesheet" href="<?php echo base_url(); ?>optimum/css/prettify.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>optimum/css/customstyle.css" />
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/bootstrap-table/dist/bootstrap-table.min.css"
        rel="stylesheet" type="text/css" />
    <link rel="stylesheet"
    ...
    <link href="<?php echo base_url(); ?>optimum/css/select2.min.css" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/tablesaw-master/dist/tablesaw.css"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/bootstrap-switch/bootstrap-switch.min.css"
        rel="stylesheet">
    <!-- summernotes CSS -->
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/summernote/dist/summernote.css"
        rel="stylesheet" />

    <!--alerts CSS -->
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/sweetalert/sweetalert.css" rel="stylesheet"
        type="text/css">

    <!-- Typehead CSS -->
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/typeahead.js-master/dist/typehead-min.css"
        rel="stylesheet">


    <!-- Wizard CSS -->
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/jquery-wizard-master/css/wizard.css"
        rel="stylesheet">
    ...
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/jquery.dataTables.min.css"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>optimum/css/buttons.dataTables.min.css" rel="stylesheet" type="text/css" />
    ...
    <!-- Timeline CSS -->
    <link
        href="<?php echo base_url(); ?>optimum/plugins/bower_components/horizontal-timeline/css/horizontal-timeline.css"
        rel="stylesheet">

    <!--nestable CSS -->
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/nestable/nestable.css" rel="stylesheet"
        type="text/css" />


    <!--Range slider CSS -->
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/ion-rangeslider/css/ion.rangeSlider.css"
        rel="stylesheet">
    <link
        href="<?php echo base_url(); ?>optimum/plugins/bower_components/ion-rangeslider/css/ion.rangeSlider.skinModern.css"
        rel="stylesheet">
    ...
    <!-- Editable CSS -->
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>optimum/plugins/bower_components/jquery-datatables-editable/datatables.css" />
  <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  
    <script src="<?php echo base_url(); ?>optimum/js/sms_counter.min.js"></script>
...
<link href="<?php echo base_url(); ?>optimum/css/tabulator_bootstrap.min.css" rel="stylesheet">
