<!-- .row -->
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">New Staff</h3>
                            ...
                            <form class="form">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-2 col-form-label">Staff ID #</label>
                                    <div class="col-10">
                                        <input class="form-control" type="text" value="Artisanal kale" id="example-text-input">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form>
                                        ...
                                        <input class="form-control form-group" type="date" value="2011-08-19" id="example-date-input">
                          ...
                          <input type="checkbox" aria-label="Checkbox for following text input">
                                ...
                                <div class="col-3">
                                    <label for="example-date-input" class="col-2 col-form-label">DOJ</label>
                                    <div class="col-3">
                                        <input class="form-control" type="date" value="2011-08-19" id="example-date-input">
                                    </div>
                                </div>      
                        ...
                        <div class="white-box">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group m-b-0">
                                    <div class="offset-sm-3 col-sm-9">
                                        <button type="submit" class="btn btn-info btn-rounded btn-sm waves-effect waves-light m-t-10">Sign in</button>
                                    </div>
                                </div>
                            </form>
                        </div>
