                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" id="exampleInputpwd1" placeholder="Enter email">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-lock"></i></div>
                                                <input type="password" class="form-control" id="exampleInputpwd2" placeholder="Enter email">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn  btn-rounded btn-sm btn-inverse waves-effect waves-light">Cancel</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="white-box">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group m-b-0">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <button type="submit" class="btn btn-rounded btn-sm btn-info waves-effect waves-light m-t-10">Sign in</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="panel-body">
                                    <form action="#">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="button" class="btn btn-rounded btn-sm btn-default">Cancel</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="submit" class="btn btn-rounded btn-sm btn-info"> <i class="fa fa-pencil"></i> Edit</button>
                                                            <button type="button" class="btn btn-rounded btn-sm btn-default">Cancel</button>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="submit" class="btn btn-rounded btn-sm btn-success"> <i class="fa fa-check"></i> Submit</button>
                                                            <button type="button" class="btn btn-rounded btn-sm btn-default">Cancel</button>
                                                        </div>
                                                    </div>
                                                </div>
