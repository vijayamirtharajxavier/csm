    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i> All Members
                ...
                <a href="" class="btn btn-info btn-sm pull-right" data-toggle="modal" data-target="#add-Member-modal"><i
                        class="fa fa-plus"></i>&nbsp;New Member</a> &nbsp;
                <?php else: ?>
                <!-- check logged user role permissions -->

                <?php if(check_power(1)):?>
                <a href="<?php echo base_url('admin/user') ?>" class="btn btn-info btn-sm pull-right"><i
                ...
                <form>
                    <div class="form-row container">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="validationServer02">Member No & Name</label>

                            <div class="input-group">
                                <input type="text" class="form-control" id="memberNumber" name="memberNumber">
                                <div class="input-group-append">
                                    <span><input type="text" class="form-control" name="memberName"
                                            id="memberName" placeholder="Member Name" value=""></span>
                                </div>
                        ...
                        <!--  <div class="col-md-4 mb-3">
                            <label for="validationServer01">Member name</label>
                            <input type="text" class="form-control is-valid" name="memberName" id="memberName"
                                placeholder="Member name" value="" required>
                            
                        </div> -->
                        <div class="col-md-4 mb-3">
                            <label for="validationServer02">Father's/Spouse name</label>

                            <div class="input-group">
                                <input type="text" class="form-control" name="fh_Name" id="fh_Name"
                                    placeholder="Father's / Spouse name" value="">
                                <div class="input-group-append">

                                    <span><select class="prepand form-control" name="check_fh" id="check_fh">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <div class="input-group">
                                <div class="form-check">
                                    <input type="radio" value="0" class="form-check-input" name="memberGender"
                                        id="memberGender" checked>
                                    &nbsp;&nbsp;&nbsp;
                                    Male
                                </div>

                                <div class="form-check">
                                    <input type="radio" value="1" class="form-check-input" style="padding-left:5px;"
                                        id="memberGender" name="memberGender">&nbsp;&nbsp;&nbsp;&nbsp;Female
                        ...
                        <div class="col-md-2 mb-3">
                            <label for="validationServerUsername">Marital </label>

                            <select class="prepand form-control" name="maritalStatus" id="maritalStatus">
                    ...
                    <div class="form-row container">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" class="form-control" id="dbirth" name="dbirth">

                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="validationServer02">Date of Join</label>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="mobile" id="mobile" name="mobile"
                                    placeholder="Mobile Number" value="">
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="validationServer02">Landline / PP</label>

                            <div class="input-group">
                                <input type="text" class="form-control" id="landline" name="landline"
                                    placeholder="Landline Number" value="">
                            </div>
                        </div>
                    ...
                    <div class="form-row container">
                        <div class="col-md-3 mb-3">
                            <label for="validationServer01">Resident Address</label>
                            <input type="text" class="form-control" name="resaddr" id="resaddr"
                                placeholder="Address...">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="validationServer02">Aadhar Number</label>
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="validationServer02">PAN Number</label>
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="validationServer02">E-Mail Address</label>
                    ...
                    <div class="form-row container">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="divsion" class="form-control" id="division">
                                <option>Division Name</option>
                            </select>
                            <input type="text" name="division_id" id="division_id" hidden>

                            <input type="text" name="designation_id" id="designation_id" hidden>
                            <input type="text" name="section_id" id="section_id" hidden>
                            <input type="text" name="department_id" id="department_id" hidden>
                            <input type="text" name="religion_id" id="religion_id" hidden>
                            <input type="text" name="caste_id" id="caste_id" hidden>
                            <input type="text" name="subcaste_id" id="subcaste_id" hidden>
                    ...
                    <div class="form-row container">
                        <div class="col-md-3 mb-3">
                            <label for="validationServer02">Section</label>
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="validationServer02">Caste</label>
                            <select name="caste" class="form-control" id="caste">
                                <option>Caste Name</option>
                            </select>
                        </div>

                        <div class="col-md-3 mb-3">
                            <label for="validationServer02">Sub Caste</label>
                            <select name="subcaste" class="form-control" id="subcaste">
                                <option>SubCaste Name</option>
                            </select>
                        </div>
                    ...
                    <div class="form-row container">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="validationServer02">Surety Link</label>

                            <div class="input-group">
                                <input type="text" class="form-control is-valid" id="surety_id" name="surety_id">
                                <div class="input-group-append">
                                    <span><input type="text" class="form-control is-valid" name="surety_name"
                                            id="surety_name" placeholder="Surety name" value=""></span>
                                </div>
                        ...
                        <div class="col-md-2 mb-3">
                            <label for="mSuretyCapital">Share Capital Op</label>
                            <input type="text" class="form-control is-valid" id="mSuretyCapital" name="mSuretyCapital">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label for="mthriftopbal">Thrift OpBalance</label>
                            <input type="text" class="form-control is-valid" id="mthriftopbal" name="mthriftopbal">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label for="loanopbal">Loan Op Balance</label>
                            <input type="text" class="form-control is-valid" id="loanopbal" name="loanopbal">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label for="loanoutstanding">Loan Outstanding</label>
                            <input type="text" class="form-control is-valid" id="loanoutstanding"
                    ...
                    <div class="form-row container">
                        ...
                        <div class="col-md-4 mb-2">
                            <label for="validationServer02">Thrift Monthly</label>




                            <input type="text" class="form-control is-valid" name="trfmon" id="trfmon"
                                placeholder="Thrift Monthly" value="">


                        </div>

                        <div class="col-md-2 mb-2">
                            <label for="validationServer02">ROI</label>
                            <input type="text" class="form-control is-valid" id="roi" name="roi">
                        </div>
                        <div class="col-md-2 mb-2">
                            <label for="validationServer02">No of Installments</label>
                            <input type="text" class="form-control is-valid" id="noi" name="noi">
                        </div>
                        <div class="col-md-2 mb-2">
                            <label for="validationServer02">Principle Amount</label>
                            <input type="text" class="form-control is-valid" id="prinamt" name="prinamt">
                        </div>
                        <div class="col-md-2 mb-2">
                            <label for="validationServer02">Memer / Staff</label>
                            <select class="form-control" name="memstf" id="memstf">
                        ...
                        <div class="col-md-2 mb-2">
                            <label for="validationServer02">Account Status</label>
                            <select class="form-control" name="accsts" id="accsts">
...
<!-- Add Member Modal -->
<div class="modal fade" id="___add-Member-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="do_upload" method="POST" enctype="multipart/form-data" id="create_Newmem">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input id="memberNumber" class="form-control" name="memberNumber"
                                                    type="text" value="<?php echo $lastmember_id; ?>" readonly>
                                            </div>
                                            <div class="input-group">
                                                ...
                                                <select id="memberGender" name="memberGender"
                                                    class="custom-select col-6 form-control"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" class="form-control" type="date" name="dbirth"
                                                    id="dbirth" onchange="dob_handler(event);">

                                                <span class="input-group-addon">Age
                                                </span>

                                                <input class="form-control form-group" type="text" id="age" name="age"
                                                    readonly>
                                            </div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input id="memberName" name="memberName" type="text" autocomplete="off"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" class="form-control" type="date" name="doj"
                                                    id="doj" onchange="doj_handler(event);">
                                        ...
                                        <td>
                                            ...
                                            <div class="picture-container">
                                                <div class="picture">
                                                    <img src="<?php echo base_url();?>optimum/images/nopic.jpg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="landline" name="landline" type="text"
                                                    class="form-control">
                                                <br>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="resaddr" name="resaddr" type="text"
                                                    class="form-control">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="division" class="custom-select col-6 form-control"
                                                    id="division">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="subdivision" class="custom-select col-6 form-control"
                                                    id="subdivision">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="department" class="custom-select col-6 form-control"
                                                    id="department">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="section" class="custom-select col-6 form-control"
                                                    id="section">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="designation" class="custom-select col-6 form-control"
                                                    id="designation">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="religion" class="custom-select col-6 form-control"
                                                    id="religion">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="caste" class="custom-select col-6 form-control"
                                                    id="caste">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="subcaste" class="custom-select col-6 form-control"
                                                    id="subcaste">
                                        ...
                                        <td>
                                            <div class="picture-container">
                                                <div class="picture-id">
                                                    <img src="<?php echo base_url();?>optimum/images/nopicid.jpg"
                                                        class="pictureid-src" id="offidcardPreview" title="">
                                        ...
                                        <td>
                                            <div class="picture-container">
                                                <div class="picture-oid">
                                                    <img src="<?php echo base_url();?>optimum/images/nopicid.jpg"
                                                        class="pictureoid-src" id="othidcardPreview" title="">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="nomineedetailsTab">
                                <table class="table">
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                <input type="checkbox" class="form-horizontal" data-width="150"
                                                    data-height="40" checked data-toggle="toggle" data-on="Father"
                                                    id="check_fh" name="check_fh" data-off="Husband"
                                                    data-onstyle="success" data-offstyle="danger" />

                                                <input autocomplete="off" type="text" id="fh_Name" name="fh_Name"
                                                    class="form-control" placeholder="Father / Husband Name" />
                                            </div>
                                    ...
                                    <table class="table" id="nomineeTbl">
                                        <thead>
                                            <th>Nominee Name &nbsp; <button id="nomineeBtn" class="btn btn-primary"><i
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                                                <td class="form-horizontal">
                                                    <div class="input-group">
                                                        <input class="form-control" type="text"
                                                            id="nominee[][nominee_name]" autocomplete="off"
                                                            name="nominee[][nominee_name]" placeholder="Nominee Name">
                                                ...
                                                <td><input class="form-control" type="date"
                                                        name="nominee[][nominee_dob]" id="nominee[][nominee_dob]"></td>
                                                <td><select class="form-control" id="nominee[][nominee_relation]"
                                                        name="nominee[][nominee_relation]">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="bnkName" name="bnkName" type="text"
                                                    class="form-control" aria-label="Text input with checkbox">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="bnkBranch" name="bnkBranch" type="text"
                                                    class="form-control">
                                            </div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="accName" name="accName" type="text"
                                                    class="form-control">
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="accNumber" name="accNumber" type="text"
                                                    class="form-control">
                                            </div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="ifscode" name="ifscode" type="text"
                                                    class="form-control">
                                            </div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="bnkAddr" name="bnkAddr" type="text"
                                                    class="form-control">
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group" id="ajxremote">
                                                ...
                                                <input autocomplete="off" id="surety_name" name="surety_name"
                                                    onchange="snamechange();" type="text"
                                                    class="form-control form-control-success typeahead" required>
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="surety_id" name="surety_id"
                                                    name="surety_id" type="text" class="typeahead form-control"
                                                    readonly>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="mSuretyCapital" name="mSuretyCapital"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="mThriftDeposit" name="mThriftDeposit"
                                                    type="text" class="form-control"
                                                    aria-label="Text input with checkbox">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="mLoanAmt" name="mLoanAmt" type="text"
                                                    class="form-control" aria-label="Text input with checkbox">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="roi" name="roi" type="text"
                                                    class="form-control" aria-label="Text input with checkbox">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="noi" name="noi" type="text"
                                                    class="form-control" aria-label="Text input with checkbox">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="principleAmt" name="principleAmt"
                                                    type="text" class="form-control"
                                                    aria-label="Text input with checkbox">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" id="insAmt" name="insAmt" type="text"
                                                    class="form-control" aria-label="Text input with checkbox">
...
<!-- Modal -->
<div class="modal fade" id="edit-Member-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div id="edit-mem-message"></div>
                <!---Stard Edit Modal--->
                <form action="updateMember" method="post" id="editNewmem">
                    <div id="show-edit-member-result"></div>
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>"
                        value="<?php echo $this->security->get_csrf_hash();?>">
...
$(document).ready(function() {
    ...
    $('#editmemberName').on('click', function() {
    ...
    $('#show-edit-member-result').find('#datepicker').on('click', function() {
        $('#show-edit-member-result').find('#datepicker').datepicker();
        console.log('date clicked');
    });
    // datepicker();
    /*
    ...
    $('#editreligion').load(url, function() {
    ...
    $('#subcaste').on('change', function() {
        var subcaste_id = $('#subcaste').val();
        console.log(subcaste_id);
        $('#subcaste_id').val(subcaste_id);
    });
    ...
    $('#subdivision').on('change', function() {
        var subdivision_id = $('#subdivision').val();
...
function form_submit() {
    ...
    document.getElementById("_createNewmem").submit();
}
...
$("#editNewmem").unbind('submit').bind('submit', function() {
    var form = $(this);
    var url = form.attr('action');
    var type = form.attr('method');
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success == true) {
                ...
                $("#edit-mem-message").fadeTo(2000, 500).slideUp(500, function() {
                    $("#success-alert").slideUp(500);
                });
                $("#editNewmem").trigger("reset");
                ...
                $("#editMemberForm").unbind('submit').bind('submit', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            //console.log(response);
                            if (response.success == true) {
                                $("#edit-Member-message").html(
                                    '<div class="alert alert-success alert-dismissible" role="alert">' +
                                    '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
                                    response.messages +
                                    '</div>');
                                $("#edit-Member-message").fadeTo(2000, 500).slideUp(500,
                                    function() {
                                        $("#success-alert").slideUp(500);
                                    });
