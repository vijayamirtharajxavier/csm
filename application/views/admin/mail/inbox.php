                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr class="unread">
                                                    ...
                                                    <td class="max-texts"> <a href="<?php echo base_url('admin/mail/inbox_details') ?>" /><span class="label label-info m-r-10">Work</span> Lorem ipsum perspiciatis unde omnis iste natus error sit voluptatem</td>
                                                    </td>
                                                ...
                                                <tr class="unread">
                                                    ...
                                                    <td class="max-texts"><a href="<?php echo base_url('admin/mail/inbox_details') ?>">Lorem ipsum perspiciatis unde omnis iste natus error sit voluptatem</a></td>
                                                    <td class="hidden-xs"><i class="fa fa-paperclip"></i></td>
                                                ...
                                                <tr class="unread">
                                                    ...
                                                    <td class="max-texts"><a href="<?php echo base_url('admin/mail/inbox_details') ?>"><span class="label label-success">Elite</span> Lorem ipsum perspiciatis unde omnis iste natus error sit voluptatem</a></td>
                                                    <td class="hidden-xs"><i class="fa fa-paperclip"></i></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="max-texts"><a href="<?php echo base_url('admin/mail/inbox_details') ?>"><span class="label label-warning">Work</span> Lorem ipsum perspiciatis unde omnis iste natus error sit voluptatem</a></td>
                                                    <td class="hidden-xs"><i class="fa fa-paperclip"></i></td>
                                                    <td class="text-right"> May 12 </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="hidden-xs"><i class="fa fa-star-o"></i></td>
                                                    <td class="hidden-xs">Hritik Roshan</td>
                                                    <td class="max-texts"><a href="<?php echo base_url('admin/mail/inbox_details') ?>"><span class="label label-info m-r-10">Work</span> Lorem ipsum perspiciatis unde omnis iste natus error sit voluptatem</a></td>
                                                    <td class="hidden-xs"><i class="fa fa-paperclip"></i></td>
                                                    <td class="text-right"> May 12 </td>
                                                </tr>
                                                <tr>
