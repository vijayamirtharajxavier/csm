                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    <div class="media m-b-30 p-t-20">
                                        ...
                                        <hr>
                                        <a class="pull-left" href="#"> <img class="media-object thumb-sm img-circle" src="<?php echo base_url(); ?>optimum/plugins/images/users/pawandeep.jpg" alt=""> </a>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2 col-xs-4">
                                            <a href="#"> <img class="img-thumbnail img-responsive" alt="attachment" src="<?php echo base_url(); ?>optimum/plugins/images/img1.jpg"> </a>
                                        </div>
                                        <div class="col-sm-2 col-xs-4">
                                            <a href="#"> <img class="img-thumbnail img-responsive" alt="attachment" src="<?php echo base_url(); ?>optimum/plugins/images/img2.jpg"> </a>
                                        </div>
                                        <div class="col-sm-2 col-xs-4">
                                            <a href="#"> <img class="img-thumbnail img-responsive" alt="attachment" src="<?php echo base_url(); ?>optimum/plugins/images/img3.jpg"> </a>
                                        </div>
                                    </div>
                                    <hr>
