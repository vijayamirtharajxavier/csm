    ...
    <hr>
         ...
         <?php if ($this->session->userdata('role') == 'admin'): ?>
              <!--  data-toggle="modal" data-target="#modalAddPayment"-->   
                    <a href="<?php echo base_url('admin/payment/oth_payment')?>" class="btn btn-info btn-sm pull-right" ><i class="fa fa-plus"></i>&nbsp;New Payment</a> &nbsp;
                <?php else: ?>
...
$('#search').on('click',function() {
 ...
 urlstr = base_url +  'getalloth_payments';
