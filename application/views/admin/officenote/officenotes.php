...
<!--
<a href=""  data-toggle="modal" data-target="#modalEditOffnote" onclick="updateOffnote(. $officenote['id']) . "><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></button></a>
