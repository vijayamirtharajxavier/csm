...
<div id="delete-journal-message"></div>
         ...
         <?php if ($this->session->userdata('role') == 'admin'): ?>
                    <a target="_blank" href="<?php echo base_url('admin/journal/create_contraJournal') ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp;New Journal</a> &nbsp;
...
<div id="edit-journal-modal" class="fade modal" role="dialog">
    ...
    <div class="modal-content" >
      ...
      <div class="modal-body">
        ...
        <input type="text" name="editcreditaccountNumber" id="editcreditaccountNumber" hidden>
        <input type="text" name="editdebitaccountNumber" id="editdebitaccountNumber" hidden>
      </div>
...
<div id="deleteModal" class="modal fade">
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <form action="#" method="post" class="form-horizontal" id="deleteJournalForm">
            <div class="modal-body">
...
var productIds = new Object();
  $('#editcraccountname').select2({
        dropdownParent: $('#editcraccountname')
    });

$("#show-edit-journal-result").find("#editcraccountname").select2();

window.base_url = <?php echo json_encode(base_url('admin/journal/')); ?>;

$("#editcraccountname").typeahead({
...
$('#search_btn').on('click',function() {
 urlstr = base_url + 'fetchJournalentryData';
...
//var table = $('#journalTable').DataTable( {
 ...
 table = $('#journalTable').DataTable({
       // "ajax": url, //'../ajax/data/arrays.txt'
         //'order' : [],
    'destroy' : true,
    'ajax': base_url + 'fetchJournalentryData'+'?fdate=' + fmDate + '&tdate=' + toDate,
    'columns': [
        {
...
{
  console.log('UpdateJournal Id Clicked '+ id);
  //$("#editdbaccountname").select2();
...
//        method:"POST",
 //       data:{ id: id },
   ...
   //       $("#editdbaccountname").select2();
        //$("#editaccountname1").select2(); 
            $("#show-edit-journal-result").html(response);
 debitAcctTypeahead($('#show-edit-journal-result').find('#editdbaccountname'));
 creditAcctTypeahead($('#show-edit-journal-result').find('#editcraccountname'));
