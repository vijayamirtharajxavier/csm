                        ...
                        <div class="white-box printableArea">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <address>
                                            <h3> &nbsp;<b class="text-danger">Codeigniter Admin</b></h3>
                                            <p class="text-muted m-l-5">M, 205, Reazi 4,
                                                <br/> KT' kellette Street Monzabe,
                                                <br/> keliti Road,
                                                <br/> Buazoun - 23465</p>
                                        </address>
                                    </div>
                                    <div class="pull-right text-right">
                                        <address>
                                            <h3>To,</h3>
                                            <h4 class="font-bold">Software & Co,</h4>
                                            <p class="text-muted m-l-30">E 104, Dharti-2,
                                                <br/> KT' kellette Street Monzabe,
                                                <br/> keliti Road,
                                                <br/> Buazoun - 23465</p>
                                            <p class="m-t-30"><b>Invoice Date :</b> <i class="fa fa-calendar"></i> 23rd Oct, 2019</p>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="text-right">
                                        <button class="btn btn-success btn-rounded btn-sm" type="submit"> Proceed to payment </button>
