 <!-- .row -->
                        ...
                        <div class="collapse m-t-15" id="pgr2" aria-expanded="true"> <pre class="line-numbers language-javascript m-t-0"><code><b>Use below code & put in column</b><br/>
                            &lt;div class="carousel-inner"&gt;
                                &lt;div class="active item"&gt;
                                  &lt;div class="overlaybg"&gt;&lt;img src="<?php echo base_url(); ?>optimum/plugins/images/news/slide1.jpg"/&gt;&lt;/div&gt;
                                ...
                                <div class="bg-theme m-b-15">
                                    <div id="myCarouse2" class="carousel vcarousel slide p-20">
                                        ...
                                        <div class="carousel-inner ">
                                            ...
                                            <div class="item">
                                                <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
                                                <div class="twi-user"><img src=".<?php echo base_url(); ?>optimum/plugins/images/users/genu.jpg" alt="user" class="img-circle img-responsive pull-left">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
                                                <div class="twi-user"><img src="<?php echo base_url(); ?>optimum/plugins/images/users/ritesh.jpg" alt="user" class="img-circle img-responsive pull-left">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                                                </div>
                                            </div>
                ...
                <!-- .row -->
                <div class="row">
                    <div class="col-lg-3 col-md-6"> <img class="img-responsive" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/big/img1.jpg">
                        <div class="white-box">
                    ...
                    <div class="col-lg-3 col-md-6"> <img class="img-responsive" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/big/img2.jpg">
                        <div class="white-box">
                            <div class="text-muted"><span class="m-r-10">May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
                            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                            <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
                    ...
                    <div class="col-lg-3 col-md-6"> <img class="img-responsive" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/big/img3.jpg">
                        <div class="white-box">
                            <div class="text-muted"><span class="m-r-10">May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
                            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                            <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
                    ...
                    <div class="col-lg-3 col-md-6"> <img class="img-responsive" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/big/img4.jpg">
                        <div class="white-box">
                            <div class="text-muted"><span class="m-r-10">May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
                            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                            <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box">
                            ...
                            <div class="steamline">
                                <div class="sl-item">
                                    <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/users/genu.jpg"> </div>
                                    <div class="sl-right">
                                ...
                                <div class="sl-item">
                                    <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/users/ritesh.jpg"> </div>
                                    <div class="sl-right">
                                        <div><a href="#">Gohn Doe</a> <span class="sl-date">5 minutes ago</span></div>
                                ...
                                <div class="sl-item">
                                    <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/users/sonu.jpg"> </div>
                                    <div class="sl-right">
                                        <div><a href="#">Gohn Doe</a> <span class="sl-date">5 minutes ago</span></div>
                                ...
                                <div class="sl-item">
                                    <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url(); ?>optimum/plugins/images/users/govinda.jpg"> </div>
                                    <div class="sl-right">
                                        <div><a href="#">Gohn Doe</a> <span class="sl-date">5 minutes ago</span></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img src="<?php echo base_url(); ?>optimum/plugins/images/large/img1.jpg" alt="user" style="100%">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img alt="img" class="thumb-lg img-circle" src="<?php echo base_url(); ?>optimum/plugins/images/users/genu.jpg"></a>
